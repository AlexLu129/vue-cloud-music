      ...
      <div class="wrapper">
        ...
        <mu-flexbox wrap="wrap" justify="space-around" class="box" :gutter="0">
          <mu-flexbox-item basis="28%" class="item" :key="item.id" v-for="item in playList">
            <router-link :to="{name: 'playListDetail', param: {id: item.id, name: item.name, coverImg: item.coverImgUrl, creator: item.creator, count: item.playCount, desc: item.description}}">
        ...
        <mu-flexbox wrap="wrap" justify="space-around" class="box" :gutter="0">
          <mu-flexbox-item basis="40%" class="mu-item">
            <img class="img-reponse" src="http://p4.music.126.net/0r0H97s-bM0lZzs6x0Ibeg==/18685100604133296.jpg?param=300y170">
            <div class="mv-name">简单爱</div>
            <div class="mv-author">周杰伦</div>
          </mu-flexbox-item>
          <mu-flexbox-item basis="40%" class="mu-item">
            <img class="img-reponse" src="http://p4.music.126.net/0r0H97s-bM0lZzs6x0Ibeg==/18685100604133296.jpg?param=300y170">
            <div class="mv-name">简单爱</div>
